...
const ThemeSettings = () => {
  ...
  return (
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:bg-main-dark-bg dark:text-white bg-white dark:[#484B52] w-400'>
        <div className='flex justify-between items-center p-4 ml-4'>
          <p className='font-semibold text-xl dark:text-white-800'>Settings</p>
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          <p className='font-semibold text-lg dark:text-white'>Theme Options</p>
          <div className='mt-4'>
            <input type="radio" id='light' name='theme' value='Light' className="cursor-pointer" onChange={setMode} checked={currentMode==='Light'} />
            <label htmlFor="light" className="dark:text-white ml-2 text-md cursor-pointer">Light</label>
          </div>
          <div className='mt-4'>
            <input type="radio" id='dark' name='theme' value='Dark' className="cursor-pointer" onChange={setMode} checked={currentMode==='Dark'} />
            <label htmlFor="dark" className="dark:text-white ml-2 text-md cursor-pointer">Dark</label>
          </div>
        </div>
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          <p className='font-semibold text-lg dark:text-white'>Theme Colors</p>
